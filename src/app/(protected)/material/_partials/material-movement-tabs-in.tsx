...
import { HashIcon, MinusIcon, PlusIcon, StickyNoteIcon } from "lucide-react";
import { useState } from "react";
import { materialIn } from "./action";

export default function MaterialMovementTabsIn({
  materialId,
}: {
  materialId: string;
}) {
